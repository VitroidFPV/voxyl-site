...
<footer class="w-full">
	<div class="h-fit bg-violet-100 dark:bg-dark-800 duration-300">
		<div class="max-w-full origin-bottom top-[2px] relative h-fit md:scale-y-[0.5] z-20">
			<svg
			...
			600 301C500 301 400 301 300 301C200 301 100 301 50 301L0 301Z"
					...
					class="duration-300 dark:fill-[#2d2441] fill-[#bca2fa]"
				/>
			</svg>
		</div>
		<div class="w-full h-fit dark:bg-[#2d2441] bg-[#bca2fa] duration-300 flex md:flex-row flex-col justify-between md:items-start items-center md:p-16 p-10 pt-8 gap-8">
			...
			<div class="flex flex-col md:w-1/4 w-full">
				...
				<FooterCredits name="heroescreed" role="Bot Development" link="https://github.com/heroescreed" />
